...
_PLAN_DATA = {
    "nybyggnad": [
        ...
        _row("Grundläggning (platta/plintar/källare)","E","Egenkontroll, foto","Konstruktionsritningar, Boverkets byggregler"),
        _row("Dränering och fuktskydd mot mark","E","Egenkontroll, foto","BFS 2024:8 (hygien/hälsa), AMA Hus"),
        _row("Radonspärr / radonåtgärder (om aktuellt)","E","Egenkontroll, foto","BFS 2024:8 (hygien/hälsa)"),
        ...
        _row("Ytterväggar inkl. isolering, ångskydd och vindskydd","E","Egenkontroll, foto","BFS 2024:8 (hygien/hälsa), BBR 31 (energi)"),
        _row("Yttertak inkl. underlagspapp/duk och takbeläggning","E","Egenkontroll, foto","Boverkets byggregler, tillverkarens anvisningar"),
        _row("Fönster och ytterdörrar (placering, infästning, tätning)","E","Egenkontroll","Ritningar, BFS 2024:8 (hygien/hälsa)"),
        _row("Lufttäthet / täthetsprovning (provtryckning)","E","Provtryckning enl. SS-EN 13829","BBR 31 / BFS 2024:14 (energi)","Före slutsamråd",oblig=True),
        _cat("Installationer"),
        ...
        _row("Ventilation – typ och dimensionering","E","Egenkontroll, funktionskontroll","BFS 2024:8 (hygien/hälsa)"),
        _row("OVK – obligatorisk ventilationskontroll","E","Besiktning av certifierad kontrollant","PBF 5 kap., Boverkets byggregler","Före slutbesked",oblig=True),
        _row("Uppvärmningssystem (om aktuellt)","E","Funktionskontroll, intyg","Boverkets byggregler, tillverkarens anvisningar"),
        _row("Brandskydd (brandvarnare, handbrandsläckare, brandfilt)","BH","Egenkontroll","BFS 2024:7 (brand), MSB:s rekommendationer"),
        _cat("Tillgänglighet och bostadsutformning"),
        _row("Tillgänglighet för personer med nedsatt rörelseförmåga","BH/E","Måttkontroll mot ritningar","BFS 2024:12 (tillgänglighet)"),
        _row("Rumshöjder och dagsljus uppfylls","BH/E","Måttkontroll","BFS 2024:12 (tillgänglighet), BFS 2024:8 (hygien/hälsa)"),
        _cat("Slutkontroll"),
    ...
    "tillbyggnad": [
        ...
        _row("Markarbete och grundläggning","E","Egenkontroll, foto","Ritningar, Boverkets byggregler"),
        _row("Dränering och fuktskydd mot mark","E","Egenkontroll, foto","BFS 2024:8 (hygien/hälsa)"),
        _cat("Stomme och klimatskal"),
        _row("Bärande stomme (väggar, balkar, pelare)","E","Egenkontroll, foto","Konstruktionsritningar"),
        _row("Yttertak inkl. anslutning mot befintligt tak","E","Egenkontroll, foto","Ritningar, Boverkets byggregler"),
        _row("Ytterväggar inkl. isolering och fuktskydd","E","Egenkontroll","BFS 2024:8 (hygien/hälsa), BBR 31 (energi)"),
        _row("Anslutning mot befintlig byggnad (täthet, köldbryggor, fukt)","E","Egenkontroll, foto","BFS 2024:8 (hygien/hälsa), BBR 31 (energi)"),
        _row("Fönster och dörrar (placering, infästning, tätning)","E","Egenkontroll","Ritningar, BFS 2024:8 (hygien/hälsa)"),
        ...
        _row("Ventilation – anslutning/utökning","E","Funktionskontroll","BFS 2024:8 (hygien/hälsa)"),
    ...
    "fasad": [
        ...
        _row("Ny fasadbeklädnad (material, infästningar, sammanfogning)","E","Egenkontroll, foto","Ritningar, Boverkets byggregler, tillverkarens anvisningar"),
        _row("Tätning och fuktskydd (skarvar, anslutningar, socklar)","E","Egenkontroll, foto","BFS 2024:8 (hygien/hälsa)"),
        _row("Kulör och material enligt bygglov","BH","Visuell jämförelse","Bygglovsbeslut"),
        _row("Fönster och dörrar (utförande, placering, kulör)","E","Egenkontroll","Ritningar, Boverkets byggregler"),
        _row("Köldbryggor och anslutningar mot takfot / sockel","E","Egenkontroll, foto","BBR 31 / BFS 2024:14 (energi)"),
        _cat("Slutkontroll"),
    ...
    "tak": [
        ...
        _row("Underlagspapp eller underlagsduk monteras korrekt","E","Egenkontroll","Tillverkarens anvisningar, Boverkets byggregler"),
        _cat("Nytt yttertak"),
        _row("Takbeläggning (pannor, plåt, shingel) lagd korrekt","E","Egenkontroll","Boverkets byggregler, tillverkarens anvisningar"),
        ...
        _row("Genomföringar (skorsten, ventilationshuvar) tätade","E","Egenkontroll, foto","Tillverkarens anvisningar, Boverkets byggregler"),
        _cat("Slutkontroll"),
    ...
    "garage": [
        ...
        _row("Brandskydd (om garaget är integrerat med bostad)","E","Egenkontroll","BFS 2024:7 (brand)"),
        _cat("Slutkontroll"),
    ...
    "komplementbostad": [
        ...
        _cat("Grund och stomme"),
        _row("Grundläggning med fuktskydd","E","Egenkontroll, foto","Ritningar, BFS 2024:8 (hygien/hälsa)"),
        _row("Dränering","E","Egenkontroll, foto","BFS 2024:8 (hygien/hälsa)"),
        _row("Bärande stomme","E","Egenkontroll","Konstruktionsritningar"),
        _cat("Klimatskal"),
        _row("Ytterväggar och tak (isolering, täthet, ångskydd)","E","Egenkontroll, foto","BFS 2024:8 (hygien/hälsa), BBR 31 (energi)"),
        _row("Fönster och dörrar – infästning och tätning","E","Egenkontroll","Ritningar, Boverkets byggregler"),
        _cat("Installationer"),
        _row("Elinstallationer","E","Intyg från behörig elinstallatör","Elsäkerhetslagen"),
        _row("VA-installationer (om bostad med vatten/avlopp)","E","Tryckprovning, intyg","Branschregler Säker Vatten"),
        _row("Ventilation","E","Injustering, funktionskontroll","BFS 2024:8 (hygien/hälsa)"),
        _row("Brandskydd (brandvarnare, handbrandsläckare, brandfilt)","BH","Egenkontroll","BFS 2024:7 (brand), MSB"),
        _cat("Slutkontroll"),
    ...
    "altan": [
        ...
        _row("Räcken och fallskydd (höjd min. 1,0 m vid fall > 0,5 m)","E","Måttkontroll, egenkontroll","BFS 2024:9 (säkerhet vid användning)",oblig=True),
        _row("Ytmaterial (träslag, impregnering, halkskydd)","E","Egenkontroll","Tillverkarens anvisningar"),
        _row("Uterum – glaspartier, tak och tätning (om aktuellt)","E","Egenkontroll","Ritningar, Boverkets byggregler"),
    ...
    "attefall": [
        ...
        _cat("Grund och stomme"),
        _row("Grundläggning (plintar/platta) med fuktskydd","E","Egenkontroll, foto","Ritningar, Boverkets byggregler"),
        ...
        _row("Brandskydd (brandvarnare, handbrandsläckare)","BH","Egenkontroll","BFS 2024:7 (brand), MSB"),
        _cat("Slutkontroll"),
    ...
    "fallback": [
        ...
        _row("Utförandet uppfyller gällande krav","BH","Egenkontroll, intyg","PBL, Boverkets byggregler, startbesked","Innan slutanmälan",oblig=True),
    ],
}
